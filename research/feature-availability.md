...
- **Excluded:** announced models without verifiable specs (e.g. Google/Samsung Android XR)
...
| Frame | Brilliant Labs | ✓ | ✓ | ✗ | ✓ | unknown |

## What the data shows (as of 2026-07-19, v1.0.0, sample size 7)
...
- **Prescription support is documented for 4** (Even G2, Ray-Ban Meta, XREAL One, Rokid Glasses), not available on 1 (Frame), and unknown for 2 (Ray-Ban Display, RayNeo X3 Pro).
- **AI assistant is documented for 5** products and **real-time translation for 3** (Even G2, Ray-Ban Meta, Rokid Glasses); the remaining products are marked `unknown` rather than assumed either way.
