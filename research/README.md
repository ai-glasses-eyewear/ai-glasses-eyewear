...
- [`feature-availability.md`](feature-availability.md) — availability matrix of
  key features across the 7 products.
- [`missing-data-report.md`](missing-data-report.md) — open questions and fields
  where the dataset is currently unknown/`null`, framed as a call for sourced
  contributions.

## Rules for research assets

1. Use **only** verified dataset facts. Do not add outside statistics, market
   figures, trends, studies, rankings, or quotes.
